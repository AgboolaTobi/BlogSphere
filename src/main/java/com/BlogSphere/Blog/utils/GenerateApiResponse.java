...
public class GenerateApiResponse {
    ...
    public static final String INVALID_PASSWORD_FORMAT = "password has a minimum of 8 charactersAt least 1 uppercase letter,At least 1 lowercase letter, and 1 number with no spaces";
    ...
    public static final String ALL_FIELDS_ARE_MANDATORY = "Email, Password and Name are mandatory registration fields";
